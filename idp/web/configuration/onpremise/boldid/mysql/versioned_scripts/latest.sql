CREATE TABLE {database_name}.BOLDTC_CredentialGroup (
    ...
    CONSTRAINT PK_BOLDTC_CredentialGroup PRIMARY KEY 
  (
  Id ASC
  )
);
...
CREATE TABLE {database_name}.BOLDTC_CredentialType (
    ...
    ModifiedDate datetime NOT NULL,
    IsActive tinyint(1) NOT NULL,
    CONSTRAINT PK_BOLDTC_CredentialType PRIMARY KEY 
  (
  Id ASC
  )
);
...
CREATE TABLE {database_name}.BOLDTC_Credentials (
    ...
    ModifiedDate datetime NOT NULL,
    IsActive tinyint(1) NOT NULL,
    CONSTRAINT PK_BOLDTC_Credentials PRIMARY KEY 
  (
  Id ASC
  )
);
...
CREATE TABLE {database_name}.BOLDTC_TenantStorageType (
    ...
    ModifiedDate datetime NOT NULL,
    IsActive tinyint(1) NOT NULL,
    CONSTRAINT PK_BOLDTC_TenantStorageType PRIMARY KEY 
  (
  Id ASC
  )
);
