...
var gridHeight = 355;
var databaseFormData, intermediateFormData, clonedDBFormData, azuredetails, amazons3details;
var storageFlag = 0;
var previousIndex = [];
    ...
    $(document).on("click", "#details-next", function () {
        ...
        if ($("#tenant-registration-form").find(".e-error").length == 0) {
            if ($(".tenant-database-form").hasClass("hide") && $(this).hasClass("database") && $("#tenant-registration-form").find(".e-error").length == 0) {
                ...
                systemSettingsDetails.StorageType = getDropDownValue("storage-type");
                preserveStorageFormData();
                if ($("#blob-storage-form").valid() && systemSettingsDetails.StorageType == "1") {
                    parent.showWaitingPopup(waitingPopUpElement);
                ...
                else if ($("#amazon-s3-storage-form").valid && systemSettingsDetails.StorageType == "2")
                {
                ...
                else if (systemSettingsDetails.StorageType == "0")
                {
                    $(".storage-form #system-settings-filestorage-container").hide();
                    moveStepper("front", 4);
                    nextToDataSecurityPage();
...
function addTenant() {
    ...
    postSystemSettingsData(systemSettingsDetails, azuredetails, selectedAdmins, tenantInfo, brandingType, true, userId, amazons3details);
