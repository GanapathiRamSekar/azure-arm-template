...
function getFormData() {
    ...
    var systemSettingsData = {
        ...
        StorageType: getDropDownValue("storage-type")
    };
...
function postSystemSettingsData(systemSettingsDetails, azuredetails, userName, tenantDetails, brandingType, isAddFromServer, userId, amazons3details) {
    ...
    setSystemSettingsData = { systemSettingsData: JSON.stringify(systemSettingsDetails), storage: JSON.stringify(storage), userName: userNameData, tenantDetails: tenantDetailsData, brandingType: brandingType, userIds: userIdValue };
    $.ajax({
