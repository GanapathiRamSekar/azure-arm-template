...
INSERT into  BOLDTC_CredentialGroup  (Name,CreatedDate,ModifiedDate,IsActive) VALUES (N'Database',now() at time zone 'utc',now() at time zone 'utc',1);

INSERT into  BOLDTC_CredentialGroup  (Name,CreatedDate,ModifiedDate,IsActive) VALUES (N'Storage',now() at time zone 'utc',now() at time zone 'utc',1);

INSERT into  BOLDTC_CredentialType  (Name,CredentialGroupId,CreatedDate,ModifiedDate,IsActive) VALUES (N'MSSQL',1,now() at time zone 'utc',now() at time zone 'utc',1);

INSERT into  BOLDTC_CredentialType  (Name,CredentialGroupId,CreatedDate,ModifiedDate,IsActive) VALUES (N'PostgreSQL',1,now() at time zone 'utc',now() at time zone 'utc',1);

INSERT into  BOLDTC_CredentialType  (Name,CredentialGroupId,CreatedDate,ModifiedDate,IsActive) VALUES (N'MySQL',1,now() at time zone 'utc',now() at time zone 'utc',1);

INSERT into  BOLDTC_CredentialType  (Name,CredentialGroupId,CreatedDate,ModifiedDate,IsActive) VALUES (N'File',2,now() at time zone 'utc',now() at time zone 'utc',1);

INSERT into  BOLDTC_CredentialType  (Name,CredentialGroupId,CreatedDate,ModifiedDate,IsActive) VALUES (N'AzureBlob',2,now() at time zone 'utc',now() at time zone 'utc',1);

INSERT into  BOLDTC_CredentialType  (Name,CredentialGroupId,CreatedDate,ModifiedDate,IsActive) VALUES (N'AmazonS3',2,now() at time zone 'utc',now() at time zone 'utc',1);
