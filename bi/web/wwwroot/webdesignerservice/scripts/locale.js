    ...
    App: {
        LocalizationContent: {
            ...
            alertWindowMesages: {
                ...
                existingConnectionFailed: "The existing connection has failed. If you click Yes, it will lose the previous widget and data and display the new connection table data. If you click No, it means connection details have only been updated.",      
            ...
            alertDialogTitle: {
				...
				ExistingConnectionFailed: "Existing Connection Failed",
            ...
            tdengineDataSource: {
                ...
                tdEngineOnpremise: "TDengine Onpremise",
	    ...
	    fieldNameChange: {
			...
			downloadUpload: {
                ...
                schemaValidationMessage: "The new schema differs from the existing one, and so the data settings in the associated widgets cannot be retained.",
